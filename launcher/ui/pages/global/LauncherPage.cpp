...
void LauncherPage::applySettings()
{
    ...
    s->set("CheckLauncherUpdatesOnStartup", ui->autoLauncherUpdateCheckBox->isChecked());
...
void LauncherPage::loadSettings()
{
    ...
    ui->autoLauncherUpdateCheckBox->setChecked(s->get("CheckLauncherUpdatesOnStartup").toBool());
